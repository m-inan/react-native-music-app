...
export default function Slider ({ positionY, miniPos }) {
	const { state: { Player } } = useContext(Context)
    ...
    onPanResponderRelease: () => {
		...
		onPanResponderGrant: ({ nativeEvent: { locationX, locationY } }) => setProgress(locationX, locationY),
		onPanResponderMove: ({ nativeEvent: { locationX, locationY } }) => setProgress(locationX, locationY)
	})
